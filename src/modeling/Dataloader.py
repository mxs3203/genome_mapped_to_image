...
class TCGAImageLoader(Dataset):
    ...
    def remove_rows_where_there_is_no_file(self):
        ...
        files = glob.glob("/home/mateo/pytorch_docker/TCGA_GenomeImage/data/{}/{}/3_dim_images/*.dat".format(self.folder, self.image_type))
    ...
    def __getitem__(self, idx):
        ...
        with open("/home/mateo/pytorch_docker/TCGA_GenomeImage/data/{}/{}/3_dim_images/{}.dat".format(self.folder, self.image_type, self.annotation.iloc[idx, self.predictor_column]), 'rb') as f:
            x = pickle.load(f)
            f.close()

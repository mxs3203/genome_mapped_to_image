...
class ConvNetSoftmax(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=4, out_channels=32, kernel_size=(7,2), stride=1)
        self.conv2 = nn.Conv2d(in_channels=32, out_channels=32, kernel_size=(2,2), stride=1)
        self.pool1 = nn.MaxPool2d(7,2)
        self.pool2 = nn.MaxPool2d(2,2)
        self.fc1 = nn.Linear(66240, 2048)
        self.drop = nn.Dropout(0.56)
        self.fc2 = nn.Linear(2048, 2048)
        self.fc3 = nn.Linear(2048, 512)
        self.fc4 = nn.Linear(512, 2)
        self.batchnorm2d = nn.BatchNorm2d(4)
        self.batchnorm1d = nn.BatchNorm1d(66240)

...
class ConvNetSoftmax(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=32, kernel_size=(12,3), stride=1)
        self.conv2 = nn.Conv2d(in_channels=32, out_channels=32, kernel_size=(2,2), stride=1)
        self.pool1 = nn.MaxPool2d(10,3)
        self.pool2 = nn.MaxPool2d(2,2)
        self.fc1 = nn.Linear(26880, 2048)
        self.drop = nn.Dropout(0.5)
        self.fc2 = nn.Linear(2048, 2048)
        self.fc3 = nn.Linear(2048, 512)
        self.fc4 = nn.Linear(512, 2)
        self.batchnorm2d = nn.BatchNorm2d(3)
        self.batchnorm1d = nn.BatchNorm1d(26880)

...
response_column = 6 # 5=met,6=wgii,7=tp53, 8= type

# Model Params
net = AE()
LR = 0.0001
checkpoint = torch.load("../src/classic_cnn/checkpoints/SquereImg-Metastatic_data.pb")
...
df = DataFrame(arr)
df['sampleid'] = ids
df.to_csv("../Results/Metastatic/encoded_genomes.csv")

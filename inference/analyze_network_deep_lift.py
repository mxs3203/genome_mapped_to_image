...
from captum.attr import IntegratedGradients, DeepLift, DeepLiftShap, FeatureAblation
...
LR =6.961986166203267e-05
checkpoint = torch.load("/home/mateo/pytorch_docker/TCGA_GenomeImage/src/modeling/models/42_SquareImg_TCGA_Square_ImgsGainLoss_harsh_Metastatic_data.pb")
    ...
    if dataset.annotation.shape[0] != 0:
        ...
        for x, y_dat , id, t in trainLoader:
            ...
            if y_dat == 1:
                ...
                attribution,conv = occlusion.attribute(x, baseline, target=int(1),
        ...
        total_df.to_csv("/home/mateo/pytorch_docker/TCGA_GenomeImage/Results/V3/{}/Square/Deep_lift_{}_{}_{}_top_{}.csv".format(folder_for_res,type, image_type, folder_for_res, number_of_genes_returned))
